...
echo "  3. github          - GitHub API + Git + Slack + web fetch (all-in-one)"
echo "  4. sequential-thinking - Problem solving"
echo "  5. postgres        - PostgreSQL database (read-only, multi-tenant)"
echo "  6. puppeteer       - Browser automation (Puppeteer fork)"
echo ""
